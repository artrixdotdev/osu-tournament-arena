<script lang="ts">
   ...
   import * as Sheet from "@ota/ui/components/ui/sheet/index.js";
...
{:else}
   ...
   >
      ...
      <div
         ...
         class={cn(
            "fixed z-10 hidden w-(--sidebar-width) transition-[left,right,width] duration-200 ease-in-out md:flex",
            "inset-y-0 top-10",
            side === "left"
